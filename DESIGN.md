...
- Collectors sense her day (location, activity, health, schedule) → pacemaker decides when to wake → wakes as a full-env resumed claude session (persona/rules/MCP/agents load, nothing stripped) → decides + acts in one place.
- Maintains a running day log; eventually reaches out to her first, unprompted, in his own voice.
